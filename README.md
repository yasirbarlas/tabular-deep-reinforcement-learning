...
We investigate the Deep Q-Network (DQN), Rainbow DQN, and Quantile Regression DQN algorithms on the ViZDoom 'Defend The Center' environment. We provide the code in standard .py form and as Jupyter Notebooks, and neither of these depend on each other to run.
